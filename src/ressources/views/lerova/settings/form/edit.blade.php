    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('lerova.settings.form.update') }}">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input title="title" type="text" id="title" name="title" class="form-control" value="{{ $form->title }}"
                                      required>
