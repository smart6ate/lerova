                ...
                <form class="form-horizontal" method="POST" action="{{ route('lerova.settings.imprint.update') }}">
                    ...
                    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input style="" id="image" value="{{ $imprint->image }}" name="image" type="hidden"
                                   data-public-key="{{env('UPLOADCARE_PUBLIC_KEY')}}" data-images-only
                                   data-crop="{{config('lerova.core.imprint.image_ratio')}}" data-clearable
                                   data-image-shrink="{{config('lerova.core.imprint.image_shrink')}}"
