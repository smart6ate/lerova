        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <ol style="padding: 0; background-color: transparent" class="breadcrumb">
                    ...
                    <li class="active">Add a new Link</li>
                </ol>

                <hr>


                <form class="form-horizontal" method="POST" action="{{ route('lerova.blog.links.store') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input type="text" id="title" placeholder="Title - Max. {{ config('lerova.core.blog.title_max') }} Characters" name="title"
                                   value="{{ old('title') }}"
                    ...
                    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input style="" id="image" value="{{ old('image') }}" name="image" type="hidden"
                                   ...
                                   data-image-shrink="{{config('lerova.blog.image_shrink')}}"
